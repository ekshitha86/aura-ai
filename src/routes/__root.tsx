...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Futuristic AI dashboard for live webcam and image emotion detection with history and analytics." },
      { property: "og:title", content: "EmotionSense AI" },
      { property: "og:description", content: "Real-time emotion intelligence with a cyberpunk dashboard." },
